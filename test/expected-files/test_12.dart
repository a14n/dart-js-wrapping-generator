...
class Person extends jsw.TypedJsObject {
  ...
  Person(Person father): super(js.context['Person'], [father == null ? null : father.$unsafe]);
  Person.withAge(Person father, int age): super(js.context['Person'], [father == null ? null : father.$unsafe, age]);
}
